...
register(
    id="Example",
    entry_point="gym.envs.mujoco.example:Example",
    max_episode_steps=1000,
    reward_threshold=9100.0,
)

register(
    id="ExampleWithSawyer",
    entry_point="gym.envs.mujoco.example_with_sawyer:ExampleWithSawyer",
    max_episode_steps=1000,
    reward_threshold=9100.0,
)
...
register(
    id="Pose",
    entry_point="gym.envs.mujoco.position_control:Pose",
    max_episode_steps=1000,
    reward_threshold=9100.0,
)